...
class importar
{
    ...
    public static function importarInventarioAPI($request, $response){
        ...
        try {
            $db = getConnection();
            $query = "UPDATE ms_inventario SET existenciaSolicitud=:existenciaSolicitud, existenciaRespuesta=:existenciaRespuesta, idUsuario=:idUsuario, fechaSolicitud=:fechaSolicitud, fechaRespuesta=:fechaRespuesta, existenciaEjecucion=:existenciaEjecucion, idEstado=:idEstado
